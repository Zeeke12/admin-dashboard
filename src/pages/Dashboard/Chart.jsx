...
const Chart = () => {
    ...
    const textColor = 'text-[#363949] dark:text-white transition-colors duration-100'
  return (
...
<h1 className={textColor}>{chartdata.title}</h1>
<h1 className={`font-extrabold text-2xl ${textColor}` }>{chartdata.price}</h1>
<h1 className={textColor}>{chartdata.time}</h1>
            </div>
            <div>
