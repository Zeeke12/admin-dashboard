...
const Sidebar = ({ onClose }) => {
  ...
  return (
    <motion.div initial={{ scale: 0 }} whileInView={{ scale: 1}} transition={{ duration: 1, type: "spring", bounce: 2 }} className='sidebar w-[250px] z-50 bg-white dark:bg-[#202528] transition-transform duration-1000 fixed top-0 h-screen drop-shadow-2xl shadow-[#4B5495] shadow-2xl'>
